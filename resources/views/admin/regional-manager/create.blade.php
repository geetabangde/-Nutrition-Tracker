               ...
               <div class="row ledger-add-form" >
                  <div class="col-12">
                     <div class="card">
                        ...
                        <form action="{{ route('admin.regional-manager.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                              <!-- state dropdown -->
                            ...
                            <div class="mb-3">
                              ...
                              <div class="text-end">
                                 <button type="submit" class="btn btn-primary">Create Regional Manager</button>
                              </div>
                        </div>
                     </form>
                     </div>
